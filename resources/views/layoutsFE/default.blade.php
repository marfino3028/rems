...
<html>
  <head>
    ...
    <link rel="shortcut icon" href="{{ asset('assets/fe/images/logo/favicon.ico') }}">
    <title>Flex Home - Real Estate site</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    
    <link media="all" type="text/css" rel="stylesheet" href="{{ asset('assets/fe/css/language-public.css') }}">
    <link media="all" type="text/css" rel="stylesheet" href="{{ asset('assets/fe/libraries/bootstrap/bootstrap.min.v4.css') }}">
    <link media="all" type="text/css" rel="stylesheet" href="{{ asset('assets/fe/libraries/fontawesome/css/all.min.css') }}">
    <link media="all" type="text/css" rel="stylesheet" href="{{ asset('assets/fe/libraries/owl-carousel/owl.carousel.min.css') }}">
    <link media="all" type="text/css" rel="stylesheet" href="{{ asset('assets/fe/libraries/owl-carousel/owl.theme.default.css') }}">
    <link media="all" type="text/css" rel="stylesheet" href="{{ asset('assets/fe/css/style.css') }}">
    <script src="{{ asset('assets/fe/libraries/jquery.min.js') }}"></script>
    <script src="{{ asset('assets/fe/libraries/bootstrap/popper.min.js') }}"></script>
    <script src="{{ asset('assets/fe/libraries/bootstrap/bootstrap.min.js') }}"></script>
    <script src="{{ asset('assets/fe/libraries/owl-carousel/owl.carousel.min.js') }}"></script>
  ...
  <body>
            ...
            <div class="content">
              ...
              <div class="topbar-right">
                ...
                <ul class="topbar-items">
                  <li class="login-item">
                    <a href="{{ route('front.index') }}"><i class="fas fa-sign-in-alt"></i>  Login</a>
                  </li>
                  <li class="login-item">
                    <a href="{{ route('front.index') }}"><i class="fas fa-user-plus"></i> Register</a>
                  </li>
                </ul>
              </div>
            </div>
    ...
    <header class="topmenu bg-light">
        ...
        <div class="row">
          <div class="col-12">
            <nav class="navbar navbar-expand-lg navbar-light">
              ...
              <img src="{{ asset('assets/fe/images/logo/logo.png') }}"
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul  class="navbar-nav justify-content-end">
                  <li class="nav-item ">
                    <a class="nav-link " href="{{ route('front.index') }}" target="_self">
                    Projects
                    </a>
                  </li>
                  <li class="nav-item ">
                ...
                <a class="btn btn-primary add-property" href="{{ route('front.index') }}">
      ...
      <div class="home_banner" style="background-image: url({{ asset('assets/fe/images/pict/banner.jpg') }})">
        <div class="topsearch">
          <form action="{{ route('front.index') }}" method="GET" id="frmhomesearch">
            ...
            <div class="input-group input-group-lg">
              <div class="input-group-prepend">
                <span class="input-group-text"><img src="{{ asset('assets/fe/images/pict/search_icon.png') }}" alt="search"></span>
              </div>
          ...
          <div class="padtop70">
            <div class="areahome">
              ...
              <div style="position:relative;">
                ...
                <i class="am-next"><img src="{{ asset('assets/fe/images/pict/aleft.png') }}" alt="pre"></i>
                <i class="am-prev"><img src="{{ asset('assets/fe/images/pict/aright.png') }}" alt="next"></i>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container-fluid w90">
        <div class="row">
          <div class="col-sm-3">
            <p>
              <a href="index.html">
              <img src="{{ asset('assets/fe/images/logo/logo.png') }}" style="max-height: 38px" alt="asd">
              </a>
            </p>
...
<script src="{{ asset('assets/fe/js/components.js') }}"></script>
<script src="{{ asset('assets/fe/js/language-public.js') }}"></script>
<link rel="stylesheet" href="{{ asset('assets/fe/css/cookie-consent.css') }}">
